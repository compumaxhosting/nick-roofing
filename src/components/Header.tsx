    ...
    return (
      <nav className="bg-[#E07B3B] px-4 md:px-12">
        <div className="container mx-auto h-24 flex items-center justify-between">
          ...
          <ul className="hidden lg:flex text-sm gap-6 font-semibold text-white cursor-pointer">
              ...
              <Link href="/">
                <span
                  className={`transition-colors duration-300 ${
                    pathname === "/" ? "text-[#36454f]" : "text-white"
                  }`}
                >
                  HOME
                </span>
            ...
            <li className="relative group">
              <Link href="/about">
                <span
                  className={`transition-colors duration-300 ${
                    pathname === "/about" ? "text-[#36454f]" : "text-white"
                  }`}
                >
                  ABOUT
                </span>
            ...
            >
              <div className="flex items-center gap-1">
                <Link href="/services">
                  <span
                    className={`transition-colors duration-300 ${
                      isServiceActive || pathname === "/services"
                        ? "text-[#36454f]"
                        : "text-white"
                    }`}
                  >
              ...
              <div
                className={`absolute left-0 top-full w-56 transition-all duration-200 ease-out ${
                  servicesOpen
                ...
                <div className="bg-[#E07B3B] rounded-md shadow-lg border border-[#36454f]">
                  <div className="py-1">
                    <Link href="/skylight-repair-hawthorne-nj">
                      <span
                        className={`block px-4 py-2 hover:bg-[#36454f] hover:text-white transition-colors duration-200 ${
                          pathname === "/skylight-repair-hawthorne-nj"
                    ...
                    <Link href="/gutter-installation-hawthorne-nj">
                      <span
                        className={`block px-4 py-2 hover:bg-[#36454f] hover:text-white transition-colors duration-200 ${
                          pathname === "/gutter-installation-hawthorne-nj"
                            ? "bg-[#36454f] text-white"
                            : "text-white"
                        }`}
                      >
                    ...
                    <Link href="/water-proofing-hawthorne-nj">
                      <span
                        className={`block px-4 py-2 hover:bg-[#36454f] hover:text-white transition-colors duration-200 ${
                          pathname === "/water-proofing-hawthorne-nj"
                            ? "bg-[#36454f] text-white"
                            : "text-white"
                        }`}
                      >
                    ...
                    <Link href="/roof-repair-hawthorne-nj">
                      <span
                        className={`block px-4 py-2 hover:bg-[#36454f] hover:text-white transition-colors duration-200 ${
                          pathname === "/roof-repair-hawthorne-nj"
                            ? "bg-[#36454f] text-white"
                            : "text-white"
                        }`}
                      >
                    ...
                    <Link href="/siding-services-hawthorne-nj">
                      <span
                        className={`block px-4 py-2 hover:bg-[#36454f] hover:text-white transition-colors duration-200 ${
                          pathname === "/siding-services-hawthorne-nj"
                            ? "bg-[#36454f] text-white"
                            : "text-white"
                        }`}
                      >
            ...
            <li className="relative group">
              <Link href="/gallery">
                <span
                  className={`transition-colors duration-300 ${
                    pathname === "/gallery" ? "text-[#36454f]" : "text-white"
                  }`}
                >
                  GALLERY
                </span>
            ...
            <li className="relative group">
              <Link href="/contact">
                <span
                  className={`transition-colors duration-300 ${
                    pathname === "/contact" ? "text-[#36454f]" : "text-white"
                  }`}
                >
                  CONTACT US
                </span>
          ...
          <div
            onClick={toggle}
            className="lg:hidden pr-4 text-white cursor-pointer"
          >
        ...
        {/* Mobile Menu */}
        <div
          className={`lg:hidden bg-[#E07B3B] transition-all duration-300 ease-in-out overflow-hidden ${
